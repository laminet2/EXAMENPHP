            ...
            <form class="" action="<?=BASE_URL?>"  method="Post" >             
                        <div class="row">
                            ...
                            <div class="form-btn col-md-6  d-flex justify-content-end ">
                               ...
                               <a name="" id="disabled" class="submit-btn pt-3 btn vert <?php echo(Session::isset("articleConfSelectionner")? "":"disabled") ?>" href="#" role="button" >Suivant <i class="fas fa-chevron-right"></i></a>
                            </div>
                 ...
                 <table class="table table-bordered" id="saveProductionTable" width="100%" cellspacing="0">
                    ...
                    <?php  foreach(Session::get("articleConfSelectionner") as $articleConf): ?>
                         <tr>
                            ...
                            <td>
                                <a name="" id="" class="btn btn-danger" href="<?=BASE_URL?>/ProductionController/deleteArticleSelectionner/articleConf-<?=$articleConf[1]->getId()?>" role="button">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach ?> 
                    <?php endif ?>     
